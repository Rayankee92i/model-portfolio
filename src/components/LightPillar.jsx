...
// WebGL support check — done at render time, no useEffect needed
const webGLCanvas = document.createElement('canvas');
const webGLSupported = !!(
  webGLCanvas.getContext('webgl') || webGLCanvas.getContext('experimental-webgl')
);
...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      pillarWidth, pillarHeight, noiseIntensity, pillarRotation, quality]);
